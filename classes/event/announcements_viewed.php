...
class announcements_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has queried the announcements for the " .
    ...
    public static function get_name() {
        return get_string('event:announcements_viewed', 'quizaccess_announcements');
    }
